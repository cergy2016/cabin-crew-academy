      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <h1 className="font-display text-4xl text-stone-900 dark:text-amber-50">
              {t((d) => d.referencePages.answerKeyTitle)}
            </h1>
          </div>
          <p className="text-stone-500 dark:text-stone-400 text-lg">
            {t((d) => d.referencePages.answerKeySubtitle)}
          </p>
        </motion.header>
        ...
        <div className="relative mb-10">
          ...
          <input
            ...
            placeholder={t((d) => d.referencePages.answerKeySearchPlaceholder)}
        ...
        {filteredUnits.length === 0 && (
          <p className="text-center text-stone-400 dark:text-stone-500 py-16">
            {t((d) => d.referencePages.answerKeyNoResults).replace('{query}', query)}
          </p>
        )}
                  ...
                  <div key={section.title}>
                    ...
                    <div className="space-y-3">
                      {section.groups.map((group, groupIdx) => (
                        <ul
                          key={groupIdx}
                          className="space-y-1 ps-4 border-s-2 border-stone-200 dark:border-white/10"
                        >
