        ...
        grammar: [
          {
            ...
            examples: [
              'If passenger assistance is required, notify the captain immediately',
              'Should turbulence occur, remain in designated positions',
              'In the event of delays, passengers must be kept informed',
            ],
          },
        ],
        exercises: [
          {
            ...
            options: [
              { text: 'Social gathering', correct: false, explanation: 'Briefings are formal operational meetings' },
              { text: 'To ensure all crew members understand flight details and safety procedures', correct: true, explanation: 'Briefings provide critical information for safe and coordinated flight operations' },
              { text: 'To discuss passenger complaints', correct: false, explanation: 'Briefings focus on flight operations' },
            ],
          },
        ],
        quiz: {
        ...
        grammar: [
          {
            ...
            examples: [
              ...
              'We understand your frustration regarding the departure postponement',
        ...
        exercises: [
          {
            ...
            options: [
              { text: 'Ignore it and hope they do not notice', correct: false },
              { text: 'Provide prompt, honest communication with regular updates', correct: true, explanation: 'Transparent communication maintains passenger confidence' },
              { text: 'Only announce after one hour of delay', correct: false },
            ],
          },
        ],
        quiz: {
        ...
        exercises: [
          {
            ...
            options: [
              { text: 'Make decisions about what you think they need', correct: false },
              { text: 'Ask the passenger what assistance they require', correct: true, explanation: 'Always ask passengers what they need rather than assuming' },
              { text: 'Ignore their special needs', correct: false },
            ],
          },
        ],
        quiz: {
        ...
        grammar: [
          {
            ...
            examples: [
              'Via taxiway alpha - using that specific route',
              'Hold short of crossing runway - stop before intersection',
              'Report position taxiway bravo - indicate where you are',
            ],
          },
        ],
        exercises: [
          {
            ...
            options: [
              { text: 'Proceed immediately without confirmation', correct: false },
              { text: 'Read back the entire clearance to confirm understanding', correct: true, explanation: 'Read-backs prevent communication errors' },
              { text: 'Taxi to a different runway than assigned', correct: false },
            ],
          },
        ],
        quiz: {
        ...
        grammar: [
          {
            ...
            examples: [
              'Wind two seven zero at eight knots',
              'Climb to flight level two-five-zero',
        ...
        exercises: [
          {
            ...
            options: [
              { text: 'Approximately ninety degrees from west', correct: false },
              { text: 'Magnetic heading and speed in knots', correct: true, explanation: 'Wind: direction and speed format' },
              { text: 'General direction like north or south', correct: false },
            ],
          },
        ],
        quiz: {
        ...
        exercises: [
          {
            ...
            options: [
              { text: 'Continue landing', correct: false },
              { text: 'Ask for clarification', correct: false },
              { text: 'Abort landing and climb away', correct: true, explanation: 'Go-around is immediate command' },
            ],
          },
        ],
        quiz: {
        ...
        grammar: [
          {
            ...
            examples: [
              'Passing one thousand feet, heading one eight zero',
              'Level at flight level two-five-zero',
              'Maintaining heading two seven zero, altitude three thousand',
            ],
          },
        ],
        exercises: [],
